...
El modelo más simple puede ser representar un modelo Bernoulli para cada paciente, con una probabilidad de éxito común, donde $X_i=1$ significa que el paciente respondió satisfactoriamente al tratamiento y $X_i=0$ que no lo hizo. 
